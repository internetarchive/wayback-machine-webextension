 ...
 */
 ...
 /*
 ======== EDITS =======
 1. Added onInstalled listener for usage stats
 2. Added setUninstallURL for uninstallation stats
 */
(function() {
        ...
        if (details.error == 'net::ERR_NAME_NOT_RESOLVED' || details.error == 'net::ERR_NAME_RESOLUTION_FAILED' ||
            ...
            wmAvailabilityCheck(details.url, function(wayback_url, url) {
                chrome.tabs.update(details.tabId, {
                    url: chrome.extension.getURL('dnserror.html') + "?url=" + wayback_url
                });
            }, function() {
...
chrome.runtime.onInstalled.addListener(function (object) {
    chrome.tabs.create({url: "http://archive.org/"}, function (tab) {
        console.log("New tab launched with http://archive.org/");
    });
});


chrome.runtime.setUninstallURL('https://blog.archive.org/2017/01/13/wayback-machine-chrome-extension-now-available/');
