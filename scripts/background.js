...
var VERSION = "2.12";
Globalstatuscode = "";
var excluded_urls = ["localhost", "0.0.0.0", "127.0.0.1"];
            ...
            if (details.statusCode == 504) {
              ...
              chrome.notifications.create(
                "wayback-notification",
                {
                  ...
                  message:
                    "View an archived version courtesy of the WayBack Machine",
                  buttons: [
                    {
...
//     },
//     function() {
//       console.log("notified and archived");
//     }
//   );
// }
  ...
  if (message.message == "openurl") {
    ...
    chrome.tabs.query({ active: true, currentWindow: true }, function(tabs) {
      ...
      if (
        ...
        url.includes("web-beta.archive.org")
      ) {
  ...
  function(details) {
    function tabIsReady(isIncognito) {
      if (
        ...
        details.error == "net::ERR_NAME_RESOLUTION_FAILED" ||
        ...
        wmAvailabilityCheck(
          ...
          function(wayback_url, url) {
            chrome.tabs.update(details.tabId, {
              url:
                chrome.extension.getURL("dnserror.html") + "?url=" + wayback_url
            });
          },
          function() {}
        );
